...
- 检查是否**编译 PIG 微服务项目**  
- 检查创**建的项目和 PIG项目版本**是否保持一致
- 检查 IDEA Maven 设置是否都是关联的目标仓库

![Maven设置](https://cdn.nlark.com/yuque/0/2022/png/283679/1661477769308-44a8e837-9bf7-406e-98d6-a32877cc5a7e.png)

- 3. 刷新 maven 面板

![刷新Maven面板](https://cdn.nlark.com/yuque/0/2022/png/283679/1661477882335-b77e0eed-f889-48dc-a0c6-9237da433cc8.png)
