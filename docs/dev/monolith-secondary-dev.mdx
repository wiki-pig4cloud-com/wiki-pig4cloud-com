...
![选择目标表](https://cdn.nlark.com/yuque/0/2024/png/283679/1724736747002-9fd05a31-65a8-4185-9f6c-4245d0adec31.png)
...
![生成代码配置](https://cdn.nlark.com/yuque/0/2024/png/283679/1724736679009-e218956c-ef8e-40ae-92eb-22643515ce6e.png)
...
![执行SQL脚本](https://cdn.nlark.com/yuque/0/2024/png/283679/1724736815336-8dce895a-0b62-43e2-9d3c-795c261ee132.png)

### 2.5 角色分配权限

最重要的一步：给角色分配权限（角色管理 > 权限）。在重新启动前端并重新登录后，请强制刷新浏览器，查看 demo 功能是否生效。

![角色权限分配](https://cdn.nlark.com/yuque/0/2024/png/283679/1704604236898-e653151a-94fb-4194-a63c-cfc7af5a6227.png)
