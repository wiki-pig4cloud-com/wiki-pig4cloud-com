...
## ③ 初始化数据库
<Note>
- **版本：mysql5.7.8+(支持 8)     默认字符集：utf8mb4   默认排序规则：utf8mb4_general_ci**
</Note>
...
3. 注意 node 版本不要太高，18 是个不错的版本选择
</Warning>

## ⑦ 打卡上榜
<Card title="打卡上榜" icon="link" href="https://www.yuque.com/docs/132585040#a6Zp1">
点击查看打卡上榜
</Card>
