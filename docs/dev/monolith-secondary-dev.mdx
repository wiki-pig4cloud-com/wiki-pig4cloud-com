...
<Card title="数据源配置" icon="database">
  ![数据源配置](https://minio.pigx.top/oss/202307/1688311202.png)
</Card>

### 2.2 选择目标表

<Card title="选择目标表" icon="table">
...
<Card title="生成代码配置" icon="settings">
...
<Card title="执行SQL脚本" icon="file-code">
