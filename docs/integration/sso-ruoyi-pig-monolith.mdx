...
## ![](/images/1689226025463-1790ba61-4503-4e4b-b397-5bba04fd77fb.png)
## 整体效果
![](/images/1599315026359-ea4af661-f598-4202-a60f-41bd4bb6324a.png)
...
> 1. 依赖于 `OAuth2`的授权码模式，pig 作为 SSO 的认证中心
...
oauth2:
  client:
    ...
    sso-server-uri: http://localhost:3000      #pig 认证中心的地址
    scope: server
```
...
![](/images/1601965363647-457dca27-c865-426a-b4ae-793101b1c763.png)
