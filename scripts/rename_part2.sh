...
if [ -f "docs/backend/microservice-basics/nacos配置中心作用.mdx" ]; then
  mv "docs/backend/microservice-basics/nacos配置中心作用.mdx" "docs/backend/microservice-basics/nacos-config-center.mdx"
  echo "Renamed: docs/backend/microservice-basics/nacos配置中心作用.mdx -> docs/backend/microservice-basics/nacos-config-center.mdx"
fi

if [ -f "docs/backend/microservice-basics/nacos-server源码运行实现.mdx" ]; then
  mv "docs/backend/microservice-basics/nacos-server源码运行实现.mdx" "docs/backend/microservice-basics/nacos-server-implementation.mdx"
...
if [ -f "docs/backend/microservice-basics/gateway业务网关作用.mdx" ]; then
  mv "docs/backend/microservice-basics/gateway业务网关作用.mdx" "docs/backend/microservice-basics/gateway-usage.mdx"
  echo "Renamed: docs/backend/microservice-basics/gateway业务网关作用.mdx -> docs/backend/microservice-basics/gateway-usage.mdx"
fi

if [ -f "docs/backend/microservice-basics/loadBalancer负载均衡器作用.mdx" ]; then
  mv "docs/backend/microservice-basics/loadBalancer负载均衡器作用.mdx" "docs/backend/microservice-basics/loadbalancer-usage.mdx"
...
if [ -f "docs/backend/microservice-basics/sentinel流量保护作用.mdx" ]; then
  mv "docs/backend/microservice-basics/sentinel流量保护作用.mdx" "docs/backend/microservice-basics/sentinel-protection.mdx"
...
# Production
if [ -f "docs/production/https部署前端项目.mdx" ]; then
  mv "docs/production/https部署前端项目.mdx" "docs/production/https-frontend-deployment.mdx"
  echo "Renamed: docs/production/https部署前端项目.mdx -> docs/production/https-frontend-deployment.mdx"
fi

if [ -f "docs/production/centos部署整套应用.mdx" ]; then
  mv "docs/production/centos部署整套应用.mdx" "docs/production/centos-deployment.mdx"
  echo "Renamed: docs/production/centos部署整套应用.mdx -> docs/production/centos-deployment.mdx"
fi

if [ -f "docs/production/Rainbond部署整套应用.mdx" ]; then
  mv "docs/production/Rainbond部署整套应用.mdx" "docs/production/rainbond-deployment.mdx"
...
# FAQ - Client Settings
if [ -f "docs/faq/client-settings/如何修改客户端pig信息.mdx" ]; then
  mv "docs/faq/client-settings/如何修改客户端pig信息.mdx" "docs/faq/client-settings/modify-client-info.mdx"
  echo "Renamed: docs/faq/client-settings/如何修改客户端pig信息.mdx -> docs/faq/client-settings/modify-client-info.mdx"
fi

# FAQ - Login Issues
if [ -f "docs/faq/login-issues/登录提示clientId不合法.mdx" ]; then
  mv "docs/faq/login-issues/登录提示clientId不合法.mdx" "docs/faq/login-issues/invalid-clientid.mdx"
