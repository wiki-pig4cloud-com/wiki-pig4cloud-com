...
![](/images/1599315066287-0a240b69-3494-476e-8892-0f4abba9ff2c.png)
...
```java
@DS("#session.tenantName")//从 session 获取
public List selectSpelBySession() {
   return userMapper.selectUsers();
}

@DS("#header.tenantName")//从 header 获取
...
@DS("#user.tenantName")//使用 spel 从复杂参数获取
