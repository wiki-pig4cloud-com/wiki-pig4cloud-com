...
(function() {
    ...
    adDiv.className = 'wwads-cn wwads-vertical wwads-sticky';
    adDiv.setAttribute('data-id', '221');
    adDiv.style.maxWidth = '180px';
    
    document.body.appendChild(adDiv); // 直接插到 body 最后面
