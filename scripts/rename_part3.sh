...
if [ -f "docs/faq/service-startup/gateway 启动报 DocConfiguration 空指针.mdx" ]; then
  mv "docs/faq/service-startup/gateway 启动报 DocConfiguration 空指针.mdx" "docs/faq/service-startup/gateway-doc-config-null.mdx"
...
if [ -f "docs/faq/service-startup/服务启动失败 Failed-to-configure-a-DataSource-url.mdx" ]; then
  mv "docs/faq/service-startup/服务启动失败 Failed-to-configure-a-DataSource-url.mdx" "docs/faq/service-startup/failed-to-configure-datasource.mdx"
...
if [ -f "docs/faq/service-startup/pig-register 启动报错失败.mdx" ]; then
  mv "docs/faq/service-startup/pig-register 启动报错失败.mdx" "docs/faq/service-startup/pig-register-startup-fail.mdx"
  echo "Renamed: docs/faq/service-startup/pig-register启动报错失败.mdx -> docs/faq/service-startup/pig-register-startup-fail.mdx"
fi

if [ -f "docs/faq/service-startup/nacos 服务列表为空.mdx" ]; then
  mv "docs/faq/service-startup/nacos 服务列表为空.mdx" "docs/faq/service-startup/nacos-service-list-empty.mdx"
  echo "Renamed: docs/faq/service-startup/nacos服务列表为空.mdx -> docs/faq/service-startup/nacos-service-list-empty.mdx"
fi

if [ -f "docs/faq/service-startup/pig 链接不上数据库.mdx" ]; then
  mv "docs/faq/service-startup/pig 链接不上数据库.mdx" "docs/faq/service-startup/pig-db-connection-fail.mdx"
  echo "Renamed: docs/faq/service-startup/pig链接不上数据库.mdx -> docs/faq/service-startup/pig-db-connection-fail.mdx"
fi

if [ -f "docs/faq/service-startup/java-jar 运行 yml 报错 input-length-1.mdx" ]; then
  mv "docs/faq/service-startup/java-jar 运行 yml 报错 input-length-1.mdx" "docs/faq/service-startup/java-jar-yml-input-length-error.mdx"
...
if [ -f "docs/faq/service-startup/fastjson 安全漏洞.mdx" ]; then
  mv "docs/faq/service-startup/fastjson 安全漏洞.mdx" "docs/faq/service-startup/fastjson-vulnerability.mdx"
  echo "Renamed: docs/faq/service-startup/fastjson安全漏洞.mdx -> docs/faq/service-startup/fastjson-vulnerability.mdx"
fi

if [ -f "docs/faq/service-startup/如何修改 pig-register 启动端口.mdx" ]; then
  mv "docs/faq/service-startup/如何修改 pig-register 启动端口.mdx" "docs/faq/service-startup/modify-pig-register-port.mdx"
  echo "Renamed: docs/faq/service-startup/如何修改pig-register启动端口.mdx -> docs/faq/service-startup/modify-pig-register-port.mdx"
fi

if [ -f "docs/faq/service-startup/升级后无法启动提示 sentinel-bean 重复.mdx" ]; then
  mv "docs/faq/service-startup/升级后无法启动提示 sentinel-bean 重复.mdx" "docs/faq/service-startup/sentinel-bean-duplicate.mdx"
...
if [ -f "docs/faq/service-startup/pig-auth 报错 Cannot-deserialize.mdx" ]; then
  mv "docs/faq/service-startup/pig-auth 报错 Cannot-deserialize.mdx" "docs/faq/service-startup/pig-auth-deserialize-error.mdx"
...
if [ -f "docs/faq/service-startup/main 方法启动失败 - 提示 yml 语法错误.mdx" ]; then
  mv "docs/faq/service-startup/main 方法启动失败 - 提示 yml 语法错误.mdx" "docs/faq/service-startup/main-yml-syntax-error.mdx"
...
if [ -f "docs/faq/deployment-issues/如何获取免费公网 Docker 镜像仓库.mdx" ]; then
  mv "docs/faq/deployment-issues/如何获取免费公网 Docker 镜像仓库.mdx" "docs/faq/deployment-issues/free-docker-registry.mdx"
  echo "Renamed: docs/faq/deployment-issues/如何获取免费公网Docker镜像仓库.mdx -> docs/faq/deployment-issues/free-docker-registry.mdx"
fi

# FAQ - Frontend Issues
if [ -f "docs/faq/frontend-issues/如何修改 pig-ui 启动端口.mdx" ]; then
  mv "docs/faq/frontend-issues/如何修改 pig-ui 启动端口.mdx" "docs/faq/frontend-issues/modify-pig-ui-port.mdx"
...
# FAQ - Code References
if [ -f "docs/faq/code-references/nacos-naming-nacos-config 的源码在哪里.mdx" ]; then
  mv "docs/faq/code-references/nacos-naming-nacos-config 的源码在哪里.mdx" "docs/faq/code-references/nacos-naming-config-source.mdx"
...
if [ -f "docs/faq/code-references/根 pom-pig-cloud-dependencies-parent 源码.mdx" ]; then
  mv "docs/faq/code-references/根 pom-pig-cloud-dependencies-parent 源码.mdx" "docs/faq/code-references/root-pom-dependencies.mdx"
